package com.example.zju_bumper_cars.SurfaceView;
...
import com.example.zju_bumper_cars.map.Constant;
import com.example.zju_bumper_cars.map.MatrixState;
import com.example.zju_bumper_cars.map.Mountion;
...
public class MySurfaceView extends GLSurfaceView {
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            Constant.yArray=Constant.loadLandforms(MySurfaceView.this.getResources(), R.mipmap.land);
